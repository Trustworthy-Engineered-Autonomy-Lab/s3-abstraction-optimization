...
def model_check_kripke(kripke_structure, verbose=False):
    ...
    for i in range(grid_resolution - 1):
        for j in range(grid_resolution - 1):
            ...
            for _ in range(max_steps):
                ...
                if is_oob_state(corners, (x1_min, x1_max), (x2_min, x2_max)):
...
def check_ground_truth(x1_params, x2_params, x_domain, grid_resolution=100):
