...
LOCAL_CHECKPOINT_PATH = Path(__file__).parent / 'artifacts' / 'cache' / CHECKPOINT_FILENAME
ACTOR_CACHE_PATH = Path(__file__).parent / 'artifacts' / 'cache' / ACTOR_CACHE_FILENAME
...
def cl_system(state: np.ndarray) -> np.ndarray:
    """Closed-loop MountainCar transition"""
...
def _actor_interval(
    ...
    """Return an interval enclosure of the actor.
    """
