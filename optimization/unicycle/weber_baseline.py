# =====================================================================
# Description: implementation of the Weber baseline in the paper.
# =====================================================================
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run Weber optimization of the unicycle abstraction."
    )
...
if __name__ == "__main__":
    ...
    reference_volume = (50.0)*(50.0)*(2*np.pi)/(cli_args.shape**3)
    ...
    print(f"  Optimal resolution:   {shape[0]}x{shape[1]}x{shape[2]}")
