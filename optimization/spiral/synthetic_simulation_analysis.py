...
class UpwardSimulationEstimator:
    """
    Tight approximation of the reverse simulation metric
    """
    ...
    def __init__(
        ...
        *,
        ...
        # Store the graph in compressed sparse row (CSR) form.
    ...
    def estimate(
        ...
        *,
        ...
        """
        Approximate max_q min_x V_H(q, x).
        """
...
# =====================================================================
# Wrapper to simplify evaluation
# =====================================================================
