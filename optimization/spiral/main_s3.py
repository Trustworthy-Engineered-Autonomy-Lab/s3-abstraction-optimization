...
# of spiral quantization parameters.
# =====================================================================
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run S3-based optimization of the spiral abstraction."
    )
...
if __name__ == "__main__":
    ...
    args['inflation_coefs'] = np.array([
        20.0/cli_args.shape/2, 20.0/cli_args.shape/2
    ])
    ...
    params_opt = s_opt.gradient_descent(
        params,
        so.upward_proxy,
        args=args,
