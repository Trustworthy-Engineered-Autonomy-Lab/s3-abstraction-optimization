...
import numpy as np
from mountain_car_system import cl_system_numeric, cl_system_jax
...
def upward_proxy_bruteforce(
        params,
        *,
        args
    ):
    """
    Numpy implementation of the upward proxy.
    """
...
def upward_proxy(
    ...
    *,
    ...
    ``temp_in`` smooths the maximum across horizon steps for each cell, and
    ``temp_out`` smooths the maximum across cells.
    """
