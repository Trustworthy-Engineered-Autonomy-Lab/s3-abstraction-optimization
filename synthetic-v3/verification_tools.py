    ...
    for i in range(grid_resolution - 1):
        ...
        for j in range(grid_resolution - 1):
            ...
            for _ in range(max_steps):
                ...
                verts = np.array([ss.dynamics(vert, x_star=XSTAR) for vert in verts])
...
def check_ground_truth_fast(
    ...
    x_edges, y_edges = so.extract_grid_params(params, shape, domain_lb, domain_ub)
    ...
    for i in range(nstates_1):
        ...
        for j in range(nstates_2):
            ...
            src = sa.cell_to_id(i, j, nstates_1, nstates_2)
...
if __name__ == "__main__":
    ...
    with open("synthetic-v3/synthetic_reach_regions.pkl", "wb") as f:
